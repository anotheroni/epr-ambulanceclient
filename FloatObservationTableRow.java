...
/**
  ...
  */
public class FloatObservationTableRow implements ObservationTableRowInterface,
   FocusEventReceiver
{
   ...
   /**
     ...
     * part of.
    */
   public FloatObservationTableRow(int recordId, int paramId,
        DB2Connect dbcon, LogHandler lg, String rowName, double minVal,
        double maxVal, Vector times, ParameterTableModel paramTModel)
   {
      this.dbcon = dbcon;
      this.lg = lg;
      ...
      ((AbstractDocument)cellEditorFld.getDocument()).
         setDocumentFilter(new LimitedFloatFilter(4));
   ...
   private void readData(Vector times)
   {
      ...
      try {
         ...
         lg.addLog(new Log(e.getMessage(),
                  "FloatObservationTableRow/readData",
         ...
         int col, int end)
   {
      ...
      if (b != null && b.booleanValue())
      {
         try {
            ...
            lg.addLog(new Log(e.getMessage(),
                     "FloatObservationTableRow/changeTime",
   ...
   public String saveRow(Vector times)
   {
      ...
      try {
         ...
         psUpd = dbcon.prepareStatement(
          ...
          lg.addLog(new Log(e.getMessage(),
                  "FloatObservationTableRow/saveRow",
