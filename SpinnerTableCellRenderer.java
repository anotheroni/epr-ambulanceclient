...
/**
  * Class that implements a table cell renderer that displays a number.
  * The renderer extends a component. It is used each time a
  ...
  */
public 
class SpinnerTableCellRenderer extends JLabel implements TableCellRenderer
{
   ...
   /**
     * Constructor, initializes some properties.
     */   
